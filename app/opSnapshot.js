...
export const OP_SNAPSHOT = {
  ...
  perLander: {
    "gay-ai": { signups: 126, subs: 6, revenue: 283.72 },
    "sissy-ai": { signups: 75, subs: 1, revenue: 7.99 },
    "ai-hentai": { signups: 47, subs: 0, revenue: 0 },
    "cuckold-ai": { signups: 47, subs: 0, revenue: 0 },
    "ai-joi": { signups: 40, subs: 1, revenue: 7.99 },
    "futanari-ai": { signups: 25, subs: 0, revenue: 0 },
    "best-ai-roleplay-chat": { signups: 9, subs: 1, revenue: 19.99 },
    "ai-boobs": { signups: 7, subs: 0, revenue: 0 },
    ...
    "femdom-ai": { signups: 5, subs: 0, revenue: 0 },
